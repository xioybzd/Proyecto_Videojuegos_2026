...
// Array con las 3 imágenes del tutorial (usando alias @/ para evitar problemas de rutas relativas)
...
export default function TutorialScreen() {
  ...
  // Reproducir sonido de clic global
  ...
  const handleVolver = async () => {
    await playClick();
    router.back(); // Regresa a la pantalla anterior (index)
  };
...
const styles = StyleSheet.create({
  ...
  backButton: {
    ...
    top: 50,
    left: 20,
    backgroundColor: 'rgba(192, 132, 182, 0.9)',
    paddingVertical: 10,
